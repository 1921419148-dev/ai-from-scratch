...
<iframe src="/static/labs/lab#python-scraping" class="widget-frame code-lab-frame" style="height:520px" title="Python 爬虫入门：让电脑帮你收集数据 Web Scraping with Python Code Lab"></iframe>
