...
![内存条实物图](/qingnian/ac-wiki/general-skills/computer-basic/SurfingTutorial/img/chap1_ram_img1.png)
...
![硬盘与分区示意图](/qingnian/ac-wiki/general-skills/computer-basic/SurfingTutorial/img/chap1_disk_img2.png)
...
| ---------------- | -------------------------- | -------------------------- | ---- | ---------- | ------------- |
| **SSD 固态硬盘** | 极快 (500-7000 MB/s)    | 有限写入次数 (TBW 指标) | 较高 | 几乎不可能 | 系统盘/游戏盘 |
| **HDD 机械硬盘** | 较慢 (100-200 MB/s)     | 机械损耗 (约 5 万小时)  | 低廉 | 可能恢复   | 数据备份盘    |
| **NVMe SSD**     | 超高速 (3500-7000 MB/s) | 同 SSD                     | 昂贵 | 不可能     | 专业工作站    |
...
| 需求   | 推荐方案       | 品牌参考                        |
| ------ | -------------- | ------------------------------- |
| 系统盘 | NVMe SSD 500GB | 三星 980 Pro 西部数据 SN770  |
| 游戏库 | SATA SSD 1-2TB | 金士顿 KC600 致钛 TiPlus5000 |
| 媒体库 | HDD 4-8TB      | 希捷酷狼 西数红盘            |
