---
title: "引入"
description: "前一页介绍的浏览器界面都非常简洁，大部分上网操作都是从地址栏开始的。"
...
![地址栏](/qingnian/ac-wiki/general-skills/computer-basic/SurfingTutorial/img/chap2_edge_location.png)
...
![域名展示](/qingnian/ac-wiki/general-skills/computer-basic/SurfingTutorial/img/chap2_domain.png)
...
- **正确操作 (直接输入网址访问)：**
  ![搜索以 url](/qingnian/ac-wiki/general-skills/computer-basic/SurfingTutorial/img/chap2_search_with_url.png)
    - **操作：** 在地址栏**直接输入** `192.168.2.1` 或 `http://192.168.2.1` 并按回车。
    - **结果：** 浏览器会**直接访问**这个 IP 地址对应的本地网页（即你的路由器登录页面）。

- **错误操作 (使用搜索引擎搜索)：**
  ![搜索以搜索引擎](/qingnian/ac-wiki/general-skills/computer-basic/SurfingTutorial/img/chap2_search_with_search_engine.png)
...
![qq 搜索](/qingnian/ac-wiki/general-skills/computer-basic/SurfingTutorial/img/chap2_search_qq1.png)
...
![qq 搜索](/qingnian/ac-wiki/general-skills/computer-basic/SurfingTutorial/img/chap2_search_qq2.png)
...
2. **通过下载站下载 (以 FastCopy 为例):**
   ![fastcopy](/qingnian/ac-wiki/general-skills/computer-basic/SurfingTutorial/img/chap2_search_fastcopy1.png)
    - 识别下载站链接 (标题含“下载”、“之家”等)。
    - **进入下载站页面后：**
      ![fastcopy](/qingnian/ac-wiki/general-skills/computer-basic/SurfingTutorial/img/chap2_search_fastcopy2.png)
...
![TorLook](/qingnian/ac-wiki/general-skills/computer-basic/SurfingTutorial/img/chap2_search_torlook.png)