---
title: "电脑与网络基础"
description: "面向新大学生的电脑、浏览器、文件与系统操作路线。"
...
- [浏览器的选择和基本设置](browser_choose)
- [搜索引擎的使用和软件的下载](search_engine)
- [浏览器的插件推荐](browser_plugins_recommend)
- [我需要杀毒软件吗](antivirus)
- [BitTorrent](bit_torrent)
- 开发者工具的一些简单操作
...
- [截图的 N 种方式](screenshot_ways)
- [文件的属性](file_attributes)
- [压缩包](unzip)
- Windows 网络设置
- [命令行与命令](command)
...
网络上关于电脑软硬件的科普知识很多。以下开源课程可以作为进一步学习入口：
