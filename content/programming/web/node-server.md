---
title: "W22 · Node HTTP 服务"
description: "HTTP 服务接收请求并返回状态码、响应头和正文。"
...
> [!abstract] 本课将学到
> 请求、响应、JSON 与端口。完成后，你会亲手修改示例并通过自动检查。

## 生活场景切入

HTTP 服务接收请求并返回状态码、响应头和正文。先把它看成解决具体问题的工具，不需要一次记住所有语法。

## 核心概念

**请求** 是本课的核心。阅读代码时，先找输入，再看处理规则，最后确认输出。遇到陌生符号时逐行运行，比死记定义更有效。
