---
title: "W16 · React 组件"
description: "React 用组件描述界面，数据变化后由框架更新需要变化的部分。"
...
> [!abstract] 本课将学到
> 组件、JSX 与根节点。完成后，你会亲手修改示例并通过自动检查。

## 生活场景切入

React 用组件描述界面，数据变化后由框架更新需要变化的部分。先把它看成解决具体问题的工具，不需要一次记住所有语法。

## 核心概念

**组件** 是本课的核心。阅读代码时，先找输入，再看处理规则，最后确认输出。遇到陌生符号时逐行运行，比死记定义更有效。
...
[[programming/web/react-props|W17 · React Props]]
