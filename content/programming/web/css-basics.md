---
title: "W4 · CSS 选择器与样式"
description: "CSS 用选择器找到元素，再用属性和值改变呈现。"
...
> [!abstract] 本课将学到
> 选择器、层叠和常用文字样式。完成后，你会亲手修改示例并通过自动检查。

## 生活场景切入

CSS 用选择器找到元素，再用属性和值改变呈现。先把它看成解决具体问题的工具，不需要一次记住所有语法。

## 核心概念

**选择器** 是本课的核心。阅读代码时，先找输入，再看处理规则，最后确认输出。遇到陌生符号时逐行运行，比死记定义更有效。
...
[[programming/web/css-box|W5 · 盒模型]]
