---
title: "W18 · React State"
description: "State 保存会影响界面的可变信息，更新它会触发重新渲染。"
...
> [!abstract] 本课将学到
> useState、事件与状态更新。完成后，你会亲手修改示例并通过自动检查。

## 生活场景切入

State 保存会影响界面的可变信息，更新它会触发重新渲染。先把它看成解决具体问题的工具，不需要一次记住所有语法。

## 核心概念

**useState** 是本课的核心。阅读代码时，先找输入，再看处理规则，最后确认输出。遇到陌生符号时逐行运行，比死记定义更有效。
...
[[programming/web/react-project|W19 · React 学习清单]]
